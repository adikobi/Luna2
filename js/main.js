document.addEventListener('DOMContentLoaded', () => {
    ...
    const QUESTIONS_365 = [
        "מה הדבר שאתה הכי אוהב במראה החיצוני שלך?",
        "איפה היית רוצה להיות ברגע זה ממש?",
        "מהי מילת הסלנג שהכי מעצבנת אותך?",
        "על איזה עקרון או ערך בחיים לעולם לא תפר?",
        "מהי העצה הכי טובה שקיבלת מההורים שלך?",
        "אם היית יכול ללמוד לדבר שפה אחת באופן מיידי, איזו שפה זו הייתה?",
        "מתי בפעם האחרונה אמרת \"לא\" למשהו שבאמת לא רצית לעשות?",
        "איזה ריח מחזיר אותך הכי מהר לילדות?",
        "מה הדבר שאתה הכי גאה שהשגת בשלוש השנים האחרונות?",
        "אם היית יכול לאכול ארוחת ערב עם כל אדם (חי או מת), במי היית בוחר?",
        "איזה סרט או ספר גרם לך לשנות את דעתך על נושא מסוים?",
        "מה הדבר שגורם לך להרגיש בטוח בעצמך?",
        "מהו הפחד הכי גדול שמעכב אותך כרגע?",
        "מהי המתנה הכי טובה שאי פעם נתת למישהו?",
        "איזה חלום ילדות קטן לא התגשם, ואתה עדיין מתגעגע אליו?",
        "מי האדם שהכי היית רוצה להכיר טוב יותר?",
        "מה היית משנה בעולם אם הייתה לך כוח-על ליום אחד?",
        "מהי תחושת החרטה הגדולה ביותר שלך עד היום?",
        "איזה כישרון חבוי יש לך שהזנחת?",
        "מתי הרגשת שהצדקת את הציפיות של עצמך?",
        "מהו הדבר שאתה הכי אוהב באופי שלך?",
        "מה הדבר הכי מוזר שיצא לך לאכול?",
        "אם היית מנהל בית ספר, מה היה השיעור החובה הראשון שהיית מוסיף למערכת?",
        "מהי ההבטחה שאתה חייב לעצמך?",
        "מהו ההרגל שהכי היית רוצה להיפטר ממנו השנה?",
        "לאיזה רגע בחיים היית רוצה לחזור ליום אחד בלבד?",
        "מה הדבר שמעלה לך חיוך אוטומטי על הפנים?",
        "מהו \"יום חופש אידיאלי\" בעיניך (מרגע שאתה קם עד שאתה הולך לישון)?",
        "מהי המחשבה הכי פרועה שהייתה לך לאחרונה?",
        "מהי המילה שהכי מתארת את השנה הנוכחית שלך עד כה?",
        "איך היית משלים את המשפט: \"אני תמיד מופתע מכמה שאני...\"?",
        "איזו תיאוריית קונספירציה אתה הכי אוהב לשמוע (גם אם אתה לא מאמין בה)?",
        "מתי בפעם האחרונה נתת עזרה למישהו זר?",
        "מהו הדבר שהכי מדאיג אותך לגבי העתיד?",
        "איזה מקום בעולם הכי השפיע על הדרך שבה אתה רואה את החיים?",
        "מי המודל לחיקוי שלך, ומדוע?",
        "מהו הדבר הכי גדול שלמדת על כסף?",
        "אם היית יכול לשלוט בבני אדם באמצעות שיר אחד בלבד, איזה שיר היית בוחר?",
        "מהי התכונה שהכי היית רוצה לאמץ ממישהו אחר?",
        "מהו הדבר שאתה תמיד דוחה, ומתי תתחייב להתחיל אותו?",
        "מהו הדבר שהכי קשה לך לסלוח עליו לאחרים?",
        "מה הדבר שרוב האנשים לא יודעים עליך?",
        "אם היית יכול להמציא חג חדש, איך הוא היה נראה ומה היה שמו?",
        "איזה טיפוס של אדם מוציא ממך את הצד הפחות נחמד?",
        "מה היית אומר לגרסה הצעירה שלך, בן/בת 16?",
        "מה הדבר שנותן לך הכי הרבה אנרגיה?",
        "אם היית יכול \"לפגוש\" את הנשמה התאומה שלך, איפה הייתם נפגשים?",
        "איזו החלטה שקיבלת שינתה את מסלול חייך לחלוטין?",
        "איך נראה \"היום המושלם\" בעיניך?",
        "מתי בפעם האחרונה בכית, ולמה?",
        "מהו הדבר הכי קליל ולא חשוב שאתה אוהב להתווכח עליו?",
        "על מה אתה צריך לסלוח לעצמך?",
        "איזה ספורטאי, אמן או דמות ציבורית אתה מעריך במיוחד, ומדוע?",
        "מה הדבר הכי יפה שראית או שמעת היום?",
        "אם היית חיה, איזו חיה היית, ומדוע?",
        "מהו הדבר הכי טעים שאכלת היום?",
        "מהי המחווה הרומנטית הכי יפה שעשו עבורך?",
        "אם היית יכול לחיות בתוך סדרה/סרט כלשהו, במה היית בוחר/ת?",
        "מהו המקום שבו אתה מרגיש הכי \"בבית\", גם אם זה לא הבית הפיזי שלך?",
        "האם אתה אדם של בוקר או אדם של לילה?",
        "מה הדבר שהכי היית רוצה שיזכרו עליך אחרי שתמות?",
        "איזה משפט קצר או ציטוט אתה משתמש בו שוב ושוב?",
        "מהי הטעות הכי טובה שעשית בחיים (כזו שלמדת ממנה המון)?",
        "איך אתה מגדיר הצלחה? האם אתה מגדיר את עצמך כ\"מצליח\"?",
        "מהי השאלה שאתה הכי שונא כששואלים אותך?",
        "אם כסף לא היה שיקול, במה היית עוסק?",
        "על מה אתה אסיר תודה ברגע זה?",
        "מה הדבר הכי נועז שעשית בחייך?",
        "איזה שיעור בחיים היית רוצה שיהיה קל יותר ללמוד?",
        "אם היית יכול לדעת את האמת המוחלטת על שאלה אחת ביקום, מה היית שואל?",
        "איך אתה מטפל בעצמך כשאתה מרגיש שאתה על סף שחיקה?",
        "מי האדם שהכי משפיע על מצב הרוח שלך, ולמה?",
        "מהו המקום שהיית רוצה לחזור לבקר בו?",
        "איזה חלום יש לך שהוא \"קטן\" יחסית, אבל עדיין לא הגשמת אותו?",
        "מה הדבר שהכי קשה לך לשמוע בביקורת?",
        "מהי המטרה הראשית שלך לחודש הקרוב?",
        "מה אתה רואה כשאתה עוצם את העיניים ומדמיין את ה\"אני\" האידיאלי שלך?",
        "איזה שיר היית בוחר שיתנגן בכל פעם שאתה נכנס לחדר?",
        "מי האדם שמצחיק אותך יותר מכולם?",
        "מהו הדבר האחד שאתה חייב להספיק לפני שתמות (Bucket List)?",
        "מה הדבר שגורם לך להרגיש שאתה מבזבז את זמנך?",
        "מהי החלטת ה\"לא-להתנצל-יותר\" שלך?",
        "איזו דמות היסטורית אתה מעריך במיוחד, ולמה?",
        "מה היית רוצה שבן או בת הזוג (או החבר/הכי טוב/ה) שלך ידעו עליך?",
        "אם היית יכול לשנות את שמך הפרטי, איך היית קורא לעצמך?",
        "מהו הדבר שגוזל ממך הכי הרבה אנרגיה?",
        "איזה \"הרגל רע\" אתה אוהב שיש לך?",
        "איפה היית רוצה לחיות כשאתה מגיע לגיל פרישה?",
        "מהו הפתרון היצירתי ביותר שמצאת לבעיה לאחרונה?",
        "מהי הקנייה הגדולה ביותר שאתה מתכנן בקרוב (מכונית, דירה, טיול, וכו')?",
        "מתי בפעם האחרונה הרגשת שמערכת יחסים בינך לבין מישהו/י אחר/ת השתנתה לטובה?",
        "איזה פודקאסט או ערוץ יוטיוב שינה את הדרך שבה אתה חושב?",
        "מהי האמונה המגבילה שהכי קשה לך לשחרר?",
        "איזו מיומנות חדשה היית רוצה ללמוד בשנה הקרובה?",
        "מה הצבע שהכי מתאר את מצב הרוח שלך כרגע?",
        "מה הדבר הכי חשוב שאתה רוצה ללמד את ילדיך (או ילדים עתידיים/אחרים)?",
        "אם היית יכול לכתוב סיסמה (מוטו) לחייך, מה היא הייתה?",
        "מתי חווית את שיא הבדידות שלך, ואיך התגברת עליה?",
        "מהי מערכת היחסים בחייך שזקוקה לתיקון?",
        "מהו הזיכרון הכי חזק שיש לך מכיתה א'?",
        "מה הדבר הכי יפה שהכנת במו ידייך?",
        "אם היו לך עוד שעתיים פנויות ביום, איך היית משתמש בהן?",
        "איזו קומפלימנט קיבלת לאחרונה שבאמת נגע לליבך?",
        "מהו סוג החרדה שאתה הכי מזדהה איתו (לדוגמה: חרדת ביצוע, חרדה חברתית)?",
        "מי האדם שאתה הכי מתגעגע אליו כרגע?",
        "מה הדבר שאתה מחזיק בו רק \"כי צריך\", ולא כי אתה באמת אוהב אותו?",
        "מה הדבר שהיית רוצה להיות יותר טוב בו, אבל אתה לא מוכן להשקיע את הזמן הדרוש?",
        "מהו חוק אצבע אחד שאתה חי לפיו?",
        "מהי המחמאה שהכי היית רוצה לקבל על העבודה שלך?",
        "מהי חוויית הנסיעה הכי גרועה שהייתה לך (מטוס, רכבת, מכונית)?",
        "איזו הרגשה (כעס, שמחה, עצב, וכו') אתה מרשה לעצמך להרגיש הכי פחות?",
        "ממה אתה הכי מפחד שאנשים אחרים יחשבו עליך?",
        "מה הדבר האחרון שגרם לך לצחוק בקול רם?",
        "האם אתה מגדיר את עצמך כאדם מאושר? למה?",
        "מהו הדבר שבגללו אתה לא מוכן להתפשר, גם אם זה גורם לחיכוכים?",
        "אם היית יכול \"למחוק\" חודש אחד מהשנה האחרונה, איזה חודש זה היה ולמה?",
        "מהו העיקרון המנחה שלך כשאתה מקבל החלטה גדולה?",
        "מהי הדרך הכי טובה בשבילך להירגע אחרי יום לחוץ?",
        "איזה ספר קלאסי (ישן) לדעתך כל אדם חייב לקרוא?",
        "מה הדבר שהכי היית רוצה לשנות במערכת החינוך הנוכחית?",
        "מהי המילה שהכי מתארת את השנה החולפת שלך?",
        "מהי ההצלחה הגדולה ביותר שלך עד היום?",
        "מהו זיכרון הילדות הכי חזק שלך?",
        "מי היה המורה שהשפיע עליך הכי הרבה, ומדוע?",
        "מה היה הצעצוע האהוב עליך כילד?",
        "מה היה הספר הראשון שבאמת אהבת?",
        "איך נראתה ארוחת הערב המשפחתית כשהיית ילד?",
        "מה היה החלום שלך כשהיית בן 10? האם הוא התגשם?",
        "לאיזה גיל אתה הכי מחכה להגיע?",
        "איזה חותם היית רוצה להשאיר בעולם?",
        "מה הצעד הבא בקריירה שלך?",
        "מהי התכונה הכי חשובה לך בחבר טוב?",
        "למי היית רוצה להגיד \"תודה\" ולא הספקת?",
        "עם מי אתה מדבר כשאתה מרגיש למטה?",
        "מי האדם שהכי השפיע על השקפת העולם שלך?",
        "אם היית זוכה בלוטו מחר, מה הדבר הראשון שהיית קונה?",
        "אם היית יכול לשנות אירוע היסטורי אחד, מה הוא היה?",
        "אם היו כותבים ספר על חייך, מה היה שמו?",
        "אם היית צריך לוותר על חוש אחד (ראייה, שמיעה וכו'), על מה היית מוותר?",
        "מה הדאגה הכי גדולה שלך נכון לעכשיו"
    ];
    ...
    function populateComposerView(entry = null, mode = 'edit') {
        ...
        if (entry) {
            ...
            } else if (journal && journal.type === 'questions_365') {
                const lastIndex = journal.lastQuestionIndex !== undefined ? journal.lastQuestionIndex : -1;
                const nextIndex = (lastIndex + 1) % QUESTIONS_365.length;
                const nextQuestion = QUESTIONS_365[nextIndex];

                const question = nextQuestion.trim().replace(/</g, "&lt;").replace(/>/g, "&gt;");
                const contentHtml = `<div class="question-item"><div class="question-text">${question}</div><div class="answer-text" contenteditable="true" placeholder="התשובה שלך..."></div></div>`;
                textInput.innerHTML = contentHtml;
            }
        }
            ...
            saveBtn.addEventListener('click', () => {
                ...
                if (isNewEntry) {
                    journalEntriesRef.push(entryData).then(() => {
                        ...
                        // After saving, update the question index if it's a questions_365 journal
                        const journal = appData.journals.find(j => j.id === appData.currentJournalId);
                        if (journal && journal.type === 'questions_365') {
                            const lastIndex = journal.lastQuestionIndex !== undefined ? journal.lastQuestionIndex : -1;
                            const nextIndex = (lastIndex + 1) % QUESTIONS_365.length;
                            journalsRef.child(appData.currentJournalId).update({ lastQuestionIndex: nextIndex }).then(() => {
                                // Optimistic update for the local state
                                journal.lastQuestionIndex = nextIndex;
                            });
                        }
                    });
                } else {
    ...
    createNewJournalBtn.addEventListener('click', () => {
        ...
        if (newName) {
            ...
            if (type !== 'folder') {
                ...
                journalData.entries = {};
                if (type === 'questions_365') {
                    journalData.lastQuestionIndex = -1;
                }
            }
